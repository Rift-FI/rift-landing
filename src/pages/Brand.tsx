...
const ICON_SET = [["wallet", "Wallet"], ["institution", "Institution"], ["financing", "Financing"], ["trade", "Settlement"], ["check", "Confirmation"], ["arrow", "Direction"], ["chevron", "Disclosure"], ["menu", "Menu"], ["close", "Close"]] as const;

export const Brand = () => <div className="rift-site">
  <CapitalNav />
  <main id="main">
    <section className="r-brand-intro"><div className="r-shell"><h1>Rift brand assets</h1><p>A consistent identity for a business that supplies liquidity to payment companies before settlement arrives.</p><div className="r-actions" style={{ marginTop: 30 }}><a href="/brand/rift-brand-kit.zip" download className="r-button r-button-primary">Download brand kit <RiftIcon name="arrow" /></a></div></div></section>
    <div className="r-shell">
      <section className="r-brand-row"><div><h2>The Rift logo</h2><p>Use the existing Rift symbol with its original proportions. Keep clear space around the logo and place it on a simple background.</p><a href="/brand/rift-symbol.png" download className="r-link">Download symbol <RiftIcon name="arrow" /></a></div><div className="r-logo-sample"><div className="r-logo"><img src="/assets/rift-logo.png" alt="Rift symbol" width="307" height="304" /><span>RIFT</span></div></div></section>
